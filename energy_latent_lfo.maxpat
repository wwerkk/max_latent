...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"patching_rect" : [ 395.0, 736.0, 53.0, 22.0 ],
					"text" : "mc.limi~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "multichannelsignal" ],
					"patching_rect" : [ 292.0, 758.0, 140.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 653.0, 236.0, 59.0, 22.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1420.0, 247.0, 57.0, 62.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 281.666666666666686, 455.0, 225.0, 22.0 ],
					"text" : "2.48 -1.44 -1.28 -1.32"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1152.0, 259.0, 53.0, 49.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 281.666666666666686, 248.0, 223.0, 22.0 ],
					"text" : "-2.16 2. 2.08 1.68"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1448.0, 720.0, 50.0, 35.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1106.0, 1017.0, 50.0, 35.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 281.666666666666686, 679.0, 222.0, 22.0 ],
					"text" : "-3. -3. -3. -3."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1242.5, 826.0, 45.0, 22.0 ],
					"text" : "1 1 1 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1135.5, 32.0, 45.0, 22.0 ],
					"text" : "0 0 0 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 582.0, 37.0, 45.0, 22.0 ],
					"text" : "0 0 0 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 899.0, 256.0, 55.0, 76.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 11.0, 455.0, 222.0, 22.0 ],
					"text" : "0.493333 0.66 0.46 0.306667"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "multichannelsignal" ],
					"patching_rect" : [ 934.0, 693.0, 160.0, 22.0 ],
					"text" : "mcs.nn~ energy_2.1 encode"
				}
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 1,
					"patching_rect" : [ 324.0, 795.5, 136.0, 47.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "multichannelsignal" ],
					"patching_rect" : [ 753.0, 625.0, 160.0, 22.0 ],
					"text" : "mcs.nn~ energy_2.1 encode"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "multichannelsignal" ],
					"patching_rect" : [ 431.5, 525.0, 160.0, 22.0 ],
					"text" : "mcs.nn~ energy_2.1 decode"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "multichannelsignal", "", "float", "list" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 226.0, 688.5, 136.0, 47.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "multichannelsignal" ],
					"patching_rect" : [ 229.5, 525.0, 160.0, 22.0 ],
					"text" : "mcs.nn~ energy_2.1 decode"
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-2", 0 ],
					"midpoints" : [ 404.5, 802.0, 559.0, 802.0, 559.0, 487.0, 931.5, 487.0 ],
					"order" : 0,
					"source" : [ "obj-30", 0 ]
				}
