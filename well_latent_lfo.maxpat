...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 332.0, 314.0, 139.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "multichannelsignal" ],
					"patching_rect" : [ 198.0, 262.0, 62.0, 22.0 ],
					"text" : "mc.cycle~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "multichannelsignal" ],
					"patching_rect" : [ 276.0, 142.0, 162.0, 22.0 ],
					"text" : "mc.wave~ custom @chans 4"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "0.177778 0.215111 0.277778 0.177778"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "0.3 0.746667 0.48 0.726667"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "multichannelsignal" ],
					"patching_rect" : [ 264.666666666666742, 96.0, 122.0, 22.0 ],
					"text" : "mc.rect~ 1 @chans 4"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "multichannelsignal" ],
					"patching_rect" : [ 934.0, 693.0, 134.0, 22.0 ],
					"text" : "mcs.nn~ well_2 encode"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1134.0, 1053.0, 50.0, 35.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 400.0, 220.0, 50.0, 116.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 11.0, 248.0, 221.0, 22.0 ],
					"text" : "0.026397 0.041188 0.018242 0.020713"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1396.0, 408.0, 55.0, 35.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "multichannelsignal" ],
					"patching_rect" : [ 753.0, 625.0, 134.0, 22.0 ],
					"text" : "mcs.nn~ well_2 encode"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "multichannelsignal" ],
					"patching_rect" : [ 431.5, 525.0, 134.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "multichannelsignal" ],
					"patching_rect" : [ 120.5, 96.0, 112.0, 22.0 ],
					"text" : "mc.tri~ 1 @chans 4"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "multichannelsignal" ],
					"patching_rect" : [ 229.5, 525.0, 134.0, 22.0 ],
					"text" : "mcs.nn~ well_2 decode"
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 790.5, 322.0, 459.75, 322.0, 459.75, 198.0, 176.5, 198.0 ],
					"order" : 1,
					"source" : [ "obj-94", 0 ]
				}
